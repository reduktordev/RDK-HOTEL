...
const testimonials = [
    {
        id: 1,
        quote: "The best hotel experience we've ever had! Every detail was perfect.",
                ...
                <div className="relative h-full flex items-center max-w-6xl mx-auto px-4">
                    <motion.div
                        ...
                        <p className="text-xl mb-8 font-light max-w-md">
                            Discover unparalleled comfort with panoramic city
                            views, world-class amenities, and bespoke service in
            ...
            <section className="py-20 bg-white">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="text-center mt-12">
                        <CTAButton>
                            <a href="./rooms">Explore All Rooms</a>
                        </CTAButton>
                    </div>
                </div>
            </section>
                        ...
                        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                <button
                                    ...
                                    Confirm Booking - ${selectedRoom?.price}
                                    /night
                                </button>
                            </div>
                        </form>
